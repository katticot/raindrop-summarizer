...
export class CLI {
  ...
  parseArguments(): CLIOptions {
    const args = parse(Deno.args, {
      ...
      string: ["tag", "collection", "output", "config", "max-videos"],
      alias: {
        h: "help",
        v: "version",
        t: "tag",
...
`;
  ...
  showBanner(): void {
    const banner = `
${this.colorize("╔══════════════════════════════════════════════════════════╗", "cyan")}
${this.colorize("║", "cyan")}  ${this.colorize("🎬 Raindrop Video Summarizer", "white", true)}                     ${this.colorize("║", "cyan")}
${this.colorize("║", "cyan")}  ${this.colorize("AI-powered video summaries from your bookmarks", "gray")}        ${this.colorize("║", "cyan")}
${this.colorize("╚══════════════════════════════════════════════════════════╝", "cyan")}
`;
    console.log(banner);
  }
  ...
  showConfigSummary(options: {
    ...
    console.log(
      `   Collection: ${this.colorize(options.collection === "0" ? "All Bookmarks" : `ID ${options.collection}`, "white")}`,
    );
    console.log(
